...
"0.2.2 jar version":https://oss.sonatype.org/content/repositories/releases/com/github/simplyscala/scalatest-embedmongo_2.10/0.2.2/scalatest-embedmongo_2.10-0.2.2.jar
...
<pre><code>
   ...
   libraryDependencies += "com.github.simplyscala" %% "scalatest-embedmongo" % "0.2.3-SNAPSHOT"
</code></pre>
