...
Only the following Scala versions 2.10 & 2.11 are currently supported.
The next version (0.2.4) will only support 2.11 & 2.12 scala version.
...
<pre><code>
    libraryDependencies += "com.github.simplyscala" %% "scalatest-embedmongo" % "0.2.3" % "test"
</code></pre>

h3. Simple JAR file

"0.2.2 jar version":https://oss.sonatype.org/content/repositories/releases/com/github/simplyscala/scalatest-embedmongo_2.10/0.2.3/scalatest-embedmongo_2.10-0.2.3.jar
...
<pre><code>
   ...
   libraryDependencies += "com.github.simplyscala" %% "scalatest-embedmongo" % "0.2.4-SNAPSHOT"
</code></pre>
...
<code>
    MyTest extends FunSuite with MongoEmbedDatabase with BeforeAndAfter {
        ...
        before {
            mongoProps = mongoStart()   // by default port = 12345 & version = Version.3.0.5
